...
#Region "Upgrade Support "
	Private Shared m_vb6FormDefInstance As frmReceptionApproval
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As frmReceptionApproval
		Get
		...
		End Get
		Set(ByVal Value As frmReceptionApproval)
			m_vb6FormDefInstance = Value
		End Set
	End Property
#End Region
#Region "Windows Form Designer generated code "
	Public Shared Function CreateInstance() As frmReceptionApproval
		Dim theInstance As New frmReceptionApproval()
	...
	<System.Diagnostics.DebuggerStepThrough()> _
	 Private Sub InitializeComponent()
		...
		Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(frmReceptionApproval))
		...
		Me.cmbStatus.Items.AddRange(New Object() {"All", "Received", "Cancelled", "Approved"})
		' 
		'chkTo
		' 
		...
		Me.cmdProviders.Location = New System.Drawing.Point(240, 16)
		...
		Me.Label8.Location = New System.Drawing.Point(264, 112)
	...
	Sub ReLoadForm(ByVal addEvents As Boolean)
		...
		If addEvents Then
			...
			AddHandler Me.Activated, AddressOf Me.frmReceptionApproval_Activated
		End If
	End Sub
#End Region
End Class